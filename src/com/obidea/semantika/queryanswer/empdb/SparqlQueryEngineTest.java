package com.obidea.semantika.queryanswer.empdb;
...
{
   private static final String CONFIG_FILE = "com/obidea/semantika/queryanswer/empdb/application.cfg.xml"; //$NON-NLS-1$
