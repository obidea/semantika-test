package com.obidea.semantika.queryanswer.pool.empdb;
...
public class SparqlQueryEnginePoolTest
{
   private static final String CONFIG_FILE = "com/obidea/semantika/queryanswer/pool/empdb/application.cfg.xml";
