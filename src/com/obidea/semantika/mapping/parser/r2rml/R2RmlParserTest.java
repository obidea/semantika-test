...
{
   private static final String ROOT_PATH = "parser/r2rml/";

   private static R2RmlParser sR2RmlParser = new R2RmlParser(getMetaModel());
   ...
   {
      FileDocumentSource inputFile = getDocumentSourceFromFile("subject-map.ttl");
      sR2RmlParser.parse(inputFile, mMappingSet, sConfiguration);
   ...
   {
      FileDocumentSource inputFile = getDocumentSourceFromFile("predicate-object-map.ttl");
      sR2RmlParser.parse(inputFile, mMappingSet, sConfiguration);
   ...
   {
      FileDocumentSource inputFile = getDocumentSourceFromFile("many-to-many.ttl");
      sR2RmlParser.parse(inputFile, mMappingSet, sConfiguration);
